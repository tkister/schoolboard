...
public class Validator {
    ...
    public static int validateMsg(/*Long msgId,*/ int msgID, String msgContent, String transmitterUsername, String receiverUsername, long sendTime) {
        /*if(msgId < 0) {
            return 1;
        }
        /*if(testMsgReg(msgId)) {
    ...
    public static int validateVer(int stunde, String klasse, String fach, String lehrer){
        if(stunde < 1){
            return 1;
        }
        if(stunde > 10){
    ...
    /*
        ...
        1/stunde zu klein
        2/stunde zu groß
        3/inadequate length, klasse empty (.length()<=0)
        4/inadequate length, klasse too long (.length()>4)
        5/inadequate length, fach too long (.length()>20)
        6/inadequate length, lehrer empty (.length()<=0)
         */
